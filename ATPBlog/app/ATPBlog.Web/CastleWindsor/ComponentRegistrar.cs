namespace ATPBlog.Web.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddApplicationServicesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("ATPBlog.ApplicationServices")
                    .Pick()
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("ATPBlog.Data")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("ATPBlog.Core"));
        }
